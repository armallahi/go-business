                ...
                <div class="col-md-6 offset-md-3 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form class="forms-sample" method="POST" action="{{ route('add') }}">
                                @csrf
                                <div class="form-group text-right">
                                    <label for="exampleInputUsername1">التكاليف الثابتة</label>
                                    <input type="number" name="fixed_costs" class="form-control text-right" id="exampleInputUsername1"
                                        placeholder="التكاليف الثابتة" required>
                                </div>
                                <div class="form-group text-right">
                                    <label for="exampleInputEmail1">التكاليف المتغيرة</label>
                                    <input type="number" name="variable_costs" class="form-control text-right" id="exampleInputEmail1"
                                        placeholder="التكاليف المتغيرة" required>
                                </div>
                                <div class="form-group text-right">
                                    <label for="exampleInputPassword1">تكاليف الأثاث</label>
                                    <input type="number" name="furniture_costs" class="form-control text-right" id="exampleInputPassword1"
                                        placeholder="تكاليف الأثاث" required>
                                </div>
                                <div class="form-group text-right">
                                    <label for="exampleInputConfirmPassword1">تكاليف المعدات</label>
                                    <input type="number" name="equipment_costs" class="form-control text-right"
                                ...
                                <div class="form-group text-right">
                                    ...
                                    <input type="number" name="rental_payment" class="form-control text-right"
                                        id="exampleInputConfirmPassword1" placeholder="سعر الإيجار" required>
                                </div>

                                <div class="form-group text-right">
                                    <label for="exampleInputConfirmPassword1">رأس المال</label>
                                    <input type="number" name="capital" class="form-control text-right"
                              ...
                              <div class="form-check form-check-flat form-check-primary">
                                ...
                                <span style="margin-left: 35%;">
                                    ...
                                    <button type="submit" class="btn btn-primary mr-2" style="background-color: #2E6891 !important;" >إضافة</button>
                                </span>
